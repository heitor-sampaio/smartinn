...
const configSchema = z.object({
    ...
    taxaImpostos: z.coerce.number().min(0).max(100).default(0),
    taxaBooking: z.coerce.number().min(0).max(100).default(0),
    taxaAirbnb: z.coerce.number().min(0).max(100).default(0),
    taxaDecolar: z.coerce.number().min(0).max(100).default(0),
    taxaExpedia: z.coerce.number().min(0).max(100).default(0),
    nome: z.string().min(2),
    ...
    try {
        ...
        const updatedPousada = await prisma.pousada.update({
            ...
            data: {
                ...
                taxaImpostos: validData.taxaImpostos,
                taxaBooking: validData.taxaBooking,
                taxaAirbnb: validData.taxaAirbnb,
                taxaDecolar: validData.taxaDecolar,
                taxaExpedia: validData.taxaExpedia,
                nome: validData.nome,
